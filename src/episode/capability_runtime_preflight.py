...
# 139 since 1.1.0: T7 now scores the commercial outcome the lifecycle reached,
# so each of the ten after-sales capabilities contributes one more pair.
RUNTIME_PREFLIGHT_MUTATION_CHECK_PAIRS_V4 = 139
